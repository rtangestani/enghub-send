...
// Make backend /uploads paths absolute for the browser:
...
return (
  <>
    ...
    <div className="container" style={{ padding: "18px 0 36px" }}>
      ...
      <div className="homeGrid" style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: 16 }}>
    ...
    >
                    <img
  src={abs(p.image) || "/images/default-project.png"}
  alt=""
  width={120}
  height={80}
  style={{ objectFit: "cover", borderRadius: 8, border: "1px solid var(--line)" }}
  onError={(e) => { e.currentTarget.src = "/images/default-project.png"; }}
/>
  ...
  {/* Banner again under the projects (smaller, no search) */}
